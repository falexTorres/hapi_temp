...
!function () {
  ...
  var findModals = function findModals(target) {
    var i;
  ...
  var getModal = function getModal(event) {
...
!function () {
  ...
  var findPopovers = function findPopovers(target) {
    var i;
  ...
  var onPopoverHidden = function onPopoverHidden() {
  ...
  var getPopover = function getPopover(e) {
  ...
  var showHidePopover = function showHidePopover(e) {
...
!function () {
  ...
  var getSlider = function getSlider(target) {
    var i;
  ...
  var setSlideNumber = function setSlideNumber(offset) {
  ...
  var onTouchMove = function onTouchMove(e) {
    ...
    resistance = slideNumber === 0 && deltaX > 0 ? pageX / sliderWidth + 1.25 : slideNumber === lastSlide && deltaX < 0 ? Math.abs(pageX) / sliderWidth + 1.25 : 1;
